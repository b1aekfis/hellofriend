Động học mô tả sự chuyển động của vật nhưng chưa đề cập tới vấn đề là tại sao vật lại chuyển động như thế này mà không như thế kia.

Động lực học nghiên cứu sự chuyển động của vật liên hệ với các nguyên nhân (sự tương tác giữa các vật) gây ra một đặc trưng nào đó của chuyển động.
...
- [các định luật về chuyển động của Newton  (Newton's laws of motion)](#các-định-luật-về-chuyển-động-của-newton--newtons-laws-of-motion)
    - [định luật đầu tiên (định luật quán tính):](#định-luật-đầu-tiên-định-luật-quán-tínhquantinh)
    - [định luật thứ hai (định luật về lực):](#định-luật-thứ-hai-định-luật-về-lựcluc)
    - [nguyên lý toán học rút ra được từ định luật đầu tiên và định luật thứ hai:](#nguyên-lý-toán-học-rút-ra-được-từ-định-luật-đầu-tiên-và-định-luật-thứ-hai)
    - [định luật bổ sung, định luật thứ ba (định luật phản lực, định luật bảo toàn động lượng):](#định-luật-bổ-sung-định-luật-thứ-ba-định-luật-phản-lực-định-luật-bảo-toàn-động-lượng)
- [các đại lượng của định luật về chuyển động của Newton:](#các-đại-lượng-của-định-luật-về-chuyển-động-của-newton)
    - [Vận tốc](#vận-tốc)
    - [Gia tốc ](#gia-tốc-a-idgiatoca)
    - [Lực ](#lực-a-idluca)
    - [Khối lượng  ](#khối-lượng-a-idquantinha-a-idkhoiluonga)
...
> *Sự thay đổi trạng thái chuyển động của một vật tỉ lệ thuận với lực tác động lên nó, và được thực hiện theo hướng của đường thẳng mà lực tác dụng.*

### nguyên lý toán học rút ra được từ định luật đầu tiên và định luật thứ hai:
...
### định luật bổ sung, định luật thứ ba (định luật phản lực, định luật bảo toàn động lượng):
...
Về mặt thuật ngữ, Khối lượng là (được định nghĩa là) lượng vật chất mà vật thể chứa đựng, theo trực quan đó, khi lần lượt tác động các lực có độ lớn xấp xỉ tương đương với nhau (cùng một kiểu tác động, có thể tạm lý tưởng hoá các lực xấp xỉ tương đương với nhau này như một lực không đổi chẳng hạn) lên các vật thể có khối lượng "trông có vẻ" càng lớn thì độ lớn gia tốc thu được càng nhỏ, hay nói cách khác, khối lượng vật thể càng lớn, hành vi bảo toàn trạng thái chuyển động của nó càng bền vững, điều này cho thấy sự tỉ lệ thuận giữa khối lượng và quán tính của vật thể. Vì vậy có thể nói, khối lượng là đại lượng đặc trưng cho quán tính của vật thể. Có thể nói như vậy ở giai đoạn này cho đến khi vật lý nguyên tử (atomic physics) nói riêng hay vật lý hạt (particle physics) nói chung được khai mở. Khi đó, khối lượng có thể được định nghĩa là một đại lượng đặc trưng cho quán tính của một hạt, hạt vật chất (chất điểm).
...
trọng cực là lực hấp dẫn của trái đất.
