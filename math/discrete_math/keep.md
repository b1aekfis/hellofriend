...
Một tập có kích thước $n$ phần tử được sắp xếp theo một trật tự: mỗi một phần tử được chọn (sắp xếp) *theo thứ tự xác định* tạo thành một bộ chứa các phần tử có trật tự xác định của tập. Mỗi bộ có trật tự *xác định và không lặp* được tính là một Hoán vị của tập (trong một tập thì các phần tử phân biệt). Như vậy, theo đó có thể định nghĩa:
...
$\implies$ Như vậy, một tập có kích thước $n$ phần tử có tối đa " $n$ giai thừa" cách để khai triển một Hoán vị.

$\Rightarrow$ Công thức được cho để tính tổng số Hoán vị của một tập kích thước $n$ phần tử: $P(n)=n!$.
